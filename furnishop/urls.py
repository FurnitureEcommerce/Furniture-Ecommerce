...
schema_view = get_schema_view(
   openapi.Info(
      title="Furnishop API",
      default_version='v1',
      description="API documentation for your e-commerce site",
      contact=openapi.Contact(email="sreelekshmisgit@gmail.com"),
   ),
   public=True,
...
urlpatterns = [
    ...
    path('api/shipping/', include("shipping_app.urls")),
